...
- systemd 单元：`opbench-retest-20260922.service`。
- 控制目录：`/root/opbench-retest-20260922/`。
- 结果目录：`/root/opbench-formal-c8bbc83/results/opbench-retest-20260922-r1` 和 `-r2`。
...
```bash
systemctl status opbench-retest-20260922
cat /root/opbench-retest-20260922/status.json
tail -n 40 /root/opbench-retest-20260922/opbench-retest-20260922-r1.log
```
